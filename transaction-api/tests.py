...
def test_post_transaction():
    new_transaction = {"name": "Test Transaction", "cost": 100.0}
...
def test_get_transaction():
    ...
    new_transaction = {"name": "Get Transaction", "cost": 50.0}
...
def test_update_transaction():
    ...
    new_transaction = {"name": "Update Transaction", "cost": 25.0}
    post_response = client.post("/api/v1/transaction", json=new_transaction)
    transaction_id = post_response.json()["id"]

    # Update transaction
    update_data = {"name": "Updated Transaction", "cost": 75.0}
    ...
    assert data["cost"] == 75.0  # Cost remains unchanged
